...
complete -c diesel -n "__fish_diesel_using_subcommand setup" -l no-default-migration -d 'Don\'t generate the default migration.'
...
complete -c diesel -n "__fish_diesel_using_subcommand database; and __fish_seen_subcommand_from setup" -l no-default-migration -d 'Don\'t generate the default migration.'
...
complete -c diesel -n "__fish_diesel_using_subcommand database; and __fish_seen_subcommand_from reset" -l no-default-migration -d 'Don\'t generate the default migration.'
...
no-doc-comments\t''"
complete -c diesel -n "__fish_diesel_using_subcommand print-schema" -l allow-tables-to-appear-in-same-query-config -d 'Group tables in allow_tables_to_appear_in_same_query!().' -r -f -a "fk_related_tables\t''
all_tables\t''
none\t''"
...
complete -c diesel -n "__fish_diesel_using_subcommand print-schema" -l pg-domains-as-custom-types -d 'A regex to distinguish domain names to generate custom types for instead of relying on underlying type.' -r
