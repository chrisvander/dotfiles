# Generated by Powerlevel10k configuration wizard on 2022-01-07 at 23:00 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_ANACONDA_SHOW_ON_COMMAND="conda|pip|python|python3|pip3"
  ...
  function prompt_my_env() {
    if [ -f "${root}/.dockerenv" ] || ([ -f /proc/1/cgroup ] && grep -q docker /proc/1/cgroup); then 
